...
class MobileCompany extends React.PureComponent{
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      status: 'All',//статус клиентов для фильтрации
      companyName: 'All',//название провайдера для фильтрации
  ...
  setAllProviders = () => {
    let newClientsForRenderFiltered = this.setFilter('All', this.state.status);
    this.setState({clientsForRenderFiltered: newClientsForRenderFiltered, companyName: 'All'});
  };
  setVelcom = () => {
  ...
  //фильтрация статуса
  setAllClients = () => {
    let newClientsForRenderFiltered = this.setFilter(this.state.companyName, 'All');
    this.setState({clientsForRenderFiltered: newClientsForRenderFiltered, status: 'All'});
  };
  setActive = () => {
  ...
  render() {
    ...
    return (
      <div className = 'MobileCompany'>
        <input type = 'button' value = 'All' onClick = {this.setAllProviders}/>
        <input type = 'button' value = 'Velcom' onClick = {this.setVelcom}/>
        <input type = 'button' value = 'MTS' onClick = {this.setMTS}/>
        <hr/>
        <input type = 'button' value = 'All' onClick = {this.setAllClients}/>
